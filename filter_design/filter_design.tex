...
\begin{lstlisting}
https://github.com/varunireddy/EE3025_IDP/tree/main/filter_design/codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/varunireddy/EE3025_IDP/tree/main/filter_design
\end{lstlisting}
...
\begin{figure}
    \centering
    \includegraphics[width = 9cm]{./figs/iir/BP_digital.eps}
